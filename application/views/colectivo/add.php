    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Colectivo Add</h3>
            </div>
            <?php echo form_open('colectivo/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="capacidadInferior" class="control-label"><span class="text-danger">*</span>CapacidadInferior</label>
						<div class="form-group">
							<input type="text" name="capacidadInferior" value="<?php echo $this->input->post('capacidadInferior'); ?>" class="form-control" id="capacidadInferior" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="capacidadSuperior" value="<?php echo $this->input->post('capacidadSuperior'); ?>" class="form-control" id="capacidadSuperior" />
