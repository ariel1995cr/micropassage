    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Viaje Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idcolectivo" class="form-control">
								...
								{
									$selected = ($colectivo['idColectivo'] == $this->input->post('idcolectivo')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idciudadorigen" class="form-control">
								...
								{
									$selected = ($ciudad['idCiudad'] == $this->input->post('idciudadorigen')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idciudadestino" class="form-control">
								...
								foreach($all_ciudades as $ciudad)
								{
									$selected = ($ciudad['idCiudad'] == $this->input->post('idciudadestino')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tarifa" value="<?php echo $this->input->post('tarifa'); ?>" class="form-control" id="tarifa" />
